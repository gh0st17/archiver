...
var (
	...
	ErrWriteDirHeaders   = errors.New("не могу записать заголовки директории")
	ErrWriteFileHeader   = errors.New("ошибка записи заголовка файла")
	ErrCompressFile      = errors.New("не могу сжать файл")
	ErrReadUncompressed  = errors.New("ошибка чтения не сжатых блоков")
...
var (
	...
	ErrSkipHeaders    = errors.New("ошибка пропуска заголовка")
	ErrDecompressFile = errors.New("ошибка распаковки файла")
	ErrSkipCRC        = errors.New("ошибка пропуска CRC")
	ErrCreateOutFile  = errors.New("не могу создать файл для распаковки")
	...
	ErrReadCompLen    = errors.New("не могу прочитать размер блока сжатых данных")
	ErrReadCompBuf    = errors.New("не могу прочитать блок сжатых данных")
...
var (
	...
	ErrReadDirHeaders   = errors.New("ошибка чтения заголовков директории")
	ErrReadFileHeaders  = errors.New("ошибка чтения заголовков файлов")
	ErrReadDirHeader    = errors.New("ошибка чтения заголовка директории")
	ErrReadFileHeader   = errors.New("ошибка чтения заголовка файла")
	ErrReadHeadersCount = errors.New("ошибка чтения числа заголовков дирктории")
